...
inline cusparseStatus_t cusparseCreateCsrHelper(cusparseSpMatDescr_t *spMatDescr, int64_t rows, int64_t cols, int64_t nnz, int *csrRowOffsets, int *csrColInd, float *csrValues, cusparseIndexBase_t idxBase)
{
    return cusparseCreateCsr(spMatDescr, rows, cols, nnz, csrRowOffsets, csrColInd, csrValues, CUSPARSE_INDEX_32I, CUSPARSE_INDEX_32I, idxBase, CUDA_R_32F);
}
inline cusparseStatus_t cusparseCreateCsrHelper(cusparseSpMatDescr_t *spMatDescr, int64_t rows, int64_t cols, int64_t nnz, int *csrRowOffsets, int *csrColInd, double *csrValues, cusparseIndexBase_t idxBase)
{
    return cusparseCreateCsr(spMatDescr, rows, cols, nnz, csrRowOffsets, csrColInd, csrValues, CUSPARSE_INDEX_32I, CUSPARSE_INDEX_32I, idxBase, CUDA_R_64F);
}
inline cusparseStatus_t cusparseCreateCsrHelper(cusparseSpMatDescr_t *, int64_t, int64_t, int64_t, int *, int *, half *, cusparseIndexBase_t)
{
    RuntimeError("Unsupported template argument(half) in cusparseCreateCsrHelper");
}

inline cusparseStatus_t cusparseCreateDnMatHelper(cusparseDnMatDescr_t *dnMatDescr, int64_t rows, int64_t cols, int64_t ld, float *values, cusparseOrder_t order)
{
    return cusparseCreateDnMat(dnMatDescr, rows, cols, ld, values, CUDA_R_32F, order);
}
inline cusparseStatus_t cusparseCreateDnMatHelper(cusparseDnMatDescr_t *dnMatDescr, int64_t rows, int64_t cols, int64_t ld, double *values, cusparseOrder_t order)
{
...
{
    return cusparseCreateSpVec(spVecDescr, size, nnz, indices, values, CUSPARSE_INDEX_32I, idxBase, CUDA_R_32F);
}
...
{
    return cusparseCreateSpVec(spVecDescr, size, nnz, indices, values, CUSPARSE_INDEX_32I, idxBase, CUDA_R_64F);
}
...
{
    RuntimeError("Unsupported template argument(half) in cusparseSpVVHelper");
}
